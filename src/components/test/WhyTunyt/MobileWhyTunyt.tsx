...
export default function MobileWhyTunyt({ features }: MobileWhyTunytProps) {
  ...
  const leftArrowPointerEvents = useTransform(smoothProgress, (p) =>
    p < 0.18 ? "none" : "auto",
  );
  ...
  const rightArrowPointerEvents = useTransform(smoothProgress, (p) =>
    p > 0.75 ? "none" : "auto",
  );
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              style={{
                ...
                pointerEvents: leftArrowPointerEvents,
              }}
            ...
            <div className="relative flex h-12 w-[140px] items-center justify-center overflow-hidden rounded-[30px] border border-white/10 bg-black/60 px-6 backdrop-blur-md">
              <motion.div
                ...
                className="absolute font-medium text-white text-[15px]"
              >
                Revenue
              </motion.div>
              <motion.div
            ...
            <motion.button
              ...
              style={{
                ...
                pointerEvents: rightArrowPointerEvents,
              }}
              className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-full border border-white/10 bg-black/60 text-white backdrop-blur-md transition-all hover:bg-white/10 active:scale-95"
            >
              <svg
...
function MobileTextItem({
  ...
  const positionClass = index < 3 ? "top-[70px]" : "bottom-[95px]";
  ...
  return (
    ...
    >
      <h3
        className="font-mosvita text-[28px] sm:text-[32px] font-semibold leading-[1.2] text-white"
