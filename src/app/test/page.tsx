  ...
  return (
    <main className="bg-black min-h-screen relative">
      ...
      <div 
        ...
        style={{
          background: "linear-gradient(90deg, #FFFF93 -25.35%, #FFC27F 11.59%, #FEA8FB 48.52%, #A7FFFF 85.46%, #8DBFFC 122.4%), #FFF"
        }}
      >
        <Footer />
      </div>
      ...
      <div className="relative z-10 bg-black rounded-b-[40px] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
        <Hero />
        <WhyTunyt />
        <GotYourBack />
        <EventCategories />
      ...
      <div className="w-full h-[638px] bg-transparent pointer-events-none"></div>
    </main>
  );
}
